...
- **Security fix**: Fixed clear-text logging of sensitive information - added `_sanitizeLogMessage()` to prevent sensitive clipboard data from being exposed in error logs
