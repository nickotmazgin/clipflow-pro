...
Download the **`clipflow-pro@nickotmazgin.github.io-*-gs45-50.zip`** asset (GNOME Shell **45–50**), install with `gnome-extensions install --force`, enable, then restart the Shell:
